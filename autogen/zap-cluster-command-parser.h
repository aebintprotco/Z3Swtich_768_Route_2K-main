...
/** @brief Parser function for "ConfigureInterface" ZCL command from "Zigbee Direct Configuration" cluster
 */
...
/** @brief Parser function for "ConfigureAnonymousJoinTimeout" ZCL command from "Zigbee Direct Configuration" cluster
 */
