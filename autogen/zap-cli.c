...
void sli_zigbee_cli_zcl_generic_tunnel_advertise_command(sl_cli_command_arg_t *arguments);
...
void sli_zigbee_cli_zcl_generic_tunnel_match_command(sl_cli_command_arg_t *arguments);
void sli_zigbee_cli_zcl_generic_tunnel_response_command(sl_cli_command_arg_t *arguments);
...
static const sl_cli_command_info_t cli_cmd_zcl_generic_tunnel_cluster_advertise_protocol_address = \
SL_CLI_COMMAND(sli_zigbee_cli_zcl_generic_tunnel_advertise_command,
            ...
            "protocol address" SL_CLI_UNIT_SEPARATOR ,
            {
                SL_CLI_ARG_STRING,
                SL_CLI_ARG_END,
            });
...
static const sl_cli_command_info_t cli_cmd_zcl_generic_tunnel_cluster_match_protocol_address = \
SL_CLI_COMMAND(sli_zigbee_cli_zcl_generic_tunnel_match_command,
...
static const sl_cli_command_info_t cli_cmd_zcl_generic_tunnel_cluster_match_protocol_address_response = \
SL_CLI_COMMAND(sli_zigbee_cli_zcl_generic_tunnel_response_command,
            ...
            "device ieee address" SL_CLI_UNIT_SEPARATOR "protocol address" SL_CLI_UNIT_SEPARATOR ,
            {
                SL_CLI_ARG_HEX,
                SL_CLI_ARG_STRING,
                SL_CLI_ARG_END,
...
static const sl_cli_command_entry_t zcl_generic_tunnel_cluster_command_table[] = {
    { "match", &cli_cmd_zcl_generic_tunnel_cluster_match_protocol_address, false },
    { "response", &cli_cmd_zcl_generic_tunnel_cluster_match_protocol_address_response, false },
    { "advertise", &cli_cmd_zcl_generic_tunnel_cluster_advertise_protocol_address, false },
    { NULL, NULL, false },
};
...
static const sl_cli_command_info_t cli_cmd_generic_tunnel_group = \
  SL_CLI_COMMAND_GROUP(zcl_generic_tunnel_cluster_command_table, "ZCL generic_tunnel cluster commands");
...
static const sl_cli_command_entry_t zcl_group_table[] = {
  ...
  { "generic-tunnel", &cli_cmd_generic_tunnel_group, false },
...
WEAK(void sli_zigbee_cli_zcl_generic_tunnel_advertise_command(sl_cli_command_arg_t *arguments)) {
...
WEAK(void sli_zigbee_cli_zcl_generic_tunnel_match_command(sl_cli_command_arg_t *arguments)) {
  uint8_t argumentTypes[1] =  { 
    SL_ZCL_CLI_ARG_STRING
  }; 
  sli_zigbee_zcl_simple_command(
...
WEAK(void sli_zigbee_cli_zcl_generic_tunnel_response_command(sl_cli_command_arg_t *arguments)) {
  uint8_t argumentTypes[2] =  { 
    SL_ZCL_CLI_ARG_HEX,
    SL_ZCL_CLI_ARG_STRING
  }; 
