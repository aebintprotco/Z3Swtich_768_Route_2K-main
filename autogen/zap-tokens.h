...
#define CREATOR_ON_OFF_3 0xB00C
#define NVM3KEY_ON_OFF_3 (NVM3KEY_DOMAIN_ZIGBEE | 0xB00C)
// Creator for attribute: on/off, endpoint: 4
#define CREATOR_ON_OFF_4 0xB00D
#define NVM3KEY_ON_OFF_4 (NVM3KEY_DOMAIN_ZIGBEE | 0xB00D)
...
DEFINE_BASIC_TOKEN(COLOR_CONTROL_COLOR_TEMPERATURE_1, tokType_color_control_color_temperature, 0x11F8)
...
DEFINE_BASIC_TOKEN(COLOR_CONTROL_COLOR_TEMPERATURE_2, tokType_color_control_color_temperature, 0x11F8)
...
#define GENERATED_TOKEN_LOADER(endpoint) do { \
  ...
  if(4 == (endpoint) || (EMBER_BROADCAST_ENDPOINT == (endpoint) && epNetwork == curNetwork)) { \
